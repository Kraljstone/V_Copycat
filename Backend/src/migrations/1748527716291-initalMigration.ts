...
export class InitalMigration1748527716291 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "cfg_states" ("id" SERIAL NOT NULL, "name_key" character varying(255), "create_datetime" TIMESTAMP NOT NULL DEFAULT now(), "update_datetime" TIMESTAMP, CONSTRAINT "UQ_7ee1415545225f208b419c01fd6" UNIQUE ("name_key"), CONSTRAINT "PK_ee90a5187a97ae0076bb8aaefdd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "cfg_cities" ("id" SERIAL NOT NULL, "city_key" character varying(255), "state_id" integer NOT NULL, "create_datetime" TIMESTAMP NOT NULL DEFAULT now(), "update_datetime" TIMESTAMP, CONSTRAINT "UQ_e82f74f76914557572da247e903" UNIQUE ("city_key"), CONSTRAINT "PK_a19a4e4ed73c38dfa07b00e0709" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cfg_cities" ADD "create_datetime" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "cfg_cities" DROP CONSTRAINT "UQ_e82f74f76914557572da247e903"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "cfg_cities" ADD CONSTRAINT "UQ_e82f74f76914557572da247e903" UNIQUE ("city_key")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "cfg_cities" ADD CONSTRAINT "FK_6f0eeca7abbf4ef48a5f9199d55" FOREIGN KEY ("state_id") REFERENCES "cfg_states"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
